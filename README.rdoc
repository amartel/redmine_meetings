...
As of 0.2.2 of this plugin, Redmine 2.0.2 or greater is required, Rails 3.2.5, as well as Gem files managed by bundler.
...
Fixed: compatibility with redmine 2.0.2 + rails 3.2.5 
