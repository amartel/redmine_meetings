...
As of 0.2.0 of this plugin, Redmine 2.0.0 or greater is required, Rails 2.3.2 (onwards), as well as Gem files managed by bundler.
...
3. <tt>git clone git://github.com/danmunn/redmine_meetings.git</tt>
4. <tt>cd ..</tt>
...
3. <tt>rm -Rf plugins/redmine_mylyn_connector</tt>
