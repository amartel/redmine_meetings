...
If you are running redmine < 1.4.2:
* gem install ri_cal

if you are running redmine >= 1.4.2, run bundle to install the gem:
* bundle install

Install redmine_meetings from your vendor/plugins directory with:
* git clone git://github.com/amartel/redmine_meetings.git -b redmine_1.4
...
0.1.2 : 2012-06-04
Fixed: compatibility with redmine 1.4.2
